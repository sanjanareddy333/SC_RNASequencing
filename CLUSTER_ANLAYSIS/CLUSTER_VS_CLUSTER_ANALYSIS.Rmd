...
cat("Top 20 variable genes across VIC clusters:\n")
print(top20_genes)
expr_matrix <- GetAssayData(subset_obj, slot = "data", assay = "RNA")[top20_genes, , drop = FALSE]

output_file_hvg <- "~/Desktop/Lab_Streeter_new/CLUSTER_ANALYSIS/VIC_cluster_weighted_expression_TOP20_HVG.csv"

# Subset output_df to top 2000 HVGs
output_df_hvg <- output_df %>%
  dplyr::filter(Gene %in% top20_genes)
