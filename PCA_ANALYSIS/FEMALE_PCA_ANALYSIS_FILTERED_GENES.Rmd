...
root_dir <- "/Users/preddy/Desktop/Lab_Streeter_new/NEW_PCA_ANALYSIS_JAN23/FEMALE_PCA_FILTERED_GENES_RESULTS"

female_its2_path <- "~/Desktop/Lab_Streeter_new/DATA/FEMALE/ITS2.csv"

FILE_PREFIX<- "FEMALE_FILTERED_GENES_"
...
cat("Merged object:", ncol(female), "spots,", nrow(female), "genes\n")
...
write.csv(
  meta,
  file.path(dir_map$SliceMapping, "female_metadata_wit h_slice_id.csv"),
  row.names = TRUE
)
